...
<head>
    ...
    <title>Sistema de Biblioteca - @yield('titulo', 'Home')</title>
...
<body class="bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    @auth
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('emprestimos.historico') }}">Histórico</a>
                        </li>
    ...
    <footer class="bg-dark text-white text-center py-3 mt-5">
        <p class="mb-0">&copy; 2026 Sistema de Biblioteca</p>
    </footer>
