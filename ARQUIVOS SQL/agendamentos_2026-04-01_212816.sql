...
--
-- Host: 127.0.0.1    Database: agendamentos
-- ------------------------------------------------------
...
CREATE TABLE `appointments` (
  ...
  `status` enum('pendente','confirmado','em_atendimento','concluido','cancelado') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pendente',
...
--
-- Dumping routines for database 'agendamentos'
--
...
-- Dump completed on 2026-04-01 21:28:19
